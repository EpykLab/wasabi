...
// checks if the AllItemsResponseWazuhDaemonStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseWazuhDaemonStats{}

// AllItemsResponseWazuhDaemonStats struct for AllItemsResponseWazuhDaemonStats
type AllItemsResponseWazuhDaemonStats struct {
	...
	AffectedItems []AllItemsResponseWazuhDaemonStatsAllOfAffectedItems `json:"affected_items"`
}

type _AllItemsResponseWazuhDaemonStats AllItemsResponseWazuhDaemonStats
...
func NewAllItemsResponseWazuhDaemonStats(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []AllItemsResponseWazuhDaemonStatsAllOfAffectedItems) *AllItemsResponseWazuhDaemonStats {
	this := AllItemsResponseWazuhDaemonStats{}
...
func (o *AllItemsResponseWazuhDaemonStats) GetAffectedItems() []AllItemsResponseWazuhDaemonStatsAllOfAffectedItems {
	if o == nil {
		var ret []AllItemsResponseWazuhDaemonStatsAllOfAffectedItems
		return ret
	}
...
func (o AllItemsResponseWazuhDaemonStats) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseWazuhDaemonStats) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseWazuhDaemonStats) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseWazuhDaemonStats := _AllItemsResponseWazuhDaemonStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseWazuhDaemonStats)

	if err != nil {
		return err
	}

	*o = AllItemsResponseWazuhDaemonStats(varAllItemsResponseWazuhDaemonStats)

	return err
}

type NullableAllItemsResponseWazuhDaemonStats struct {
	value *AllItemsResponseWazuhDaemonStats
	isSet bool
}

func (v NullableAllItemsResponseWazuhDaemonStats) Get() *AllItemsResponseWazuhDaemonStats {
	return v.value
}

func (v *NullableAllItemsResponseWazuhDaemonStats) Set(val *AllItemsResponseWazuhDaemonStats) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseWazuhDaemonStats) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseWazuhDaemonStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseWazuhDaemonStats(val *AllItemsResponseWazuhDaemonStats) *NullableAllItemsResponseWazuhDaemonStats {
	return &NullableAllItemsResponseWazuhDaemonStats{value: val, isSet: true}
}

func (v NullableAllItemsResponseWazuhDaemonStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseWazuhDaemonStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
