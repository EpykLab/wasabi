...
// checks if the RuleFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleFile{}

// RuleFile struct for RuleFile
...
func (o RuleFile) MarshalJSON() ([]byte, error) {
...
func (o RuleFile) ToMap() (map[string]interface{}, error) {
...
type NullableRuleFile struct {
	value *RuleFile
	isSet bool
}

func (v NullableRuleFile) Get() *RuleFile {
	return v.value
}

func (v *NullableRuleFile) Set(val *RuleFile) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleFile) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleFile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleFile(val *RuleFile) *NullableRuleFile {
	return &NullableRuleFile{value: val, isSet: true}
}

func (v NullableRuleFile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleFile) UnmarshalJSON(src []byte) error {
	v.isSet = true
