...
// checks if the AllItemsResponseListsFiles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseListsFiles{}

// AllItemsResponseListsFiles struct for AllItemsResponseListsFiles
type AllItemsResponseListsFiles struct {
	...
	AffectedItems []RulesetFile `json:"affected_items"`
}

type _AllItemsResponseListsFiles AllItemsResponseListsFiles
...
func NewAllItemsResponseListsFiles(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []RulesetFile) *AllItemsResponseListsFiles {
	this := AllItemsResponseListsFiles{}
...
func (o AllItemsResponseListsFiles) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseListsFiles) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseListsFiles) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseListsFiles := _AllItemsResponseListsFiles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseListsFiles)

	if err != nil {
		return err
	}

	*o = AllItemsResponseListsFiles(varAllItemsResponseListsFiles)

	return err
}

type NullableAllItemsResponseListsFiles struct {
	value *AllItemsResponseListsFiles
	isSet bool
}

func (v NullableAllItemsResponseListsFiles) Get() *AllItemsResponseListsFiles {
	return v.value
}

func (v *NullableAllItemsResponseListsFiles) Set(val *AllItemsResponseListsFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseListsFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseListsFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseListsFiles(val *AllItemsResponseListsFiles) *NullableAllItemsResponseListsFiles {
	return &NullableAllItemsResponseListsFiles{value: val, isSet: true}
}

func (v NullableAllItemsResponseListsFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseListsFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
