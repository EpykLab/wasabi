...
// checks if the WazuhAnalysisdStatsAgentsItemAgentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsAgentsItemAgentsInner{}

// WazuhAnalysisdStatsAgentsItemAgentsInner struct for WazuhAnalysisdStatsAgentsItemAgentsInner
type WazuhAnalysisdStatsAgentsItemAgentsInner struct {
	// When the count of the metrics started
	Uptime *time.Time `json:"uptime,omitempty"`
	// Agent ID
	Id *int32 `json:"id,omitempty"`
	Metrics *WazuhAnalysisdStatsAgentsItemAgentsInnerMetrics `json:"metrics,omitempty"`
}
...
func NewWazuhAnalysisdStatsAgentsItemAgentsInner() *WazuhAnalysisdStatsAgentsItemAgentsInner {
	this := WazuhAnalysisdStatsAgentsItemAgentsInner{}
	return &this
}
...
func (o *WazuhAnalysisdStatsAgentsItemAgentsInner) GetMetrics() WazuhAnalysisdStatsAgentsItemAgentsInnerMetrics {
	if o == nil || IsNil(o.Metrics) {
		var ret WazuhAnalysisdStatsAgentsItemAgentsInnerMetrics
		return ret
	}
	return *o.Metrics
}
...
// SetMetrics gets a reference to the given WazuhAnalysisdStatsAgentsItemAgentsInnerMetrics and assigns it to the Metrics field.
func (o *WazuhAnalysisdStatsAgentsItemAgentsInner) SetMetrics(v WazuhAnalysisdStatsAgentsItemAgentsInnerMetrics) {
	o.Metrics = &v
}

func (o WazuhAnalysisdStatsAgentsItemAgentsInner) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsAgentsItemAgentsInner) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsAgentsItemAgentsInner struct {
	value *WazuhAnalysisdStatsAgentsItemAgentsInner
	isSet bool
}

func (v NullableWazuhAnalysisdStatsAgentsItemAgentsInner) Get() *WazuhAnalysisdStatsAgentsItemAgentsInner {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsAgentsItemAgentsInner) Set(val *WazuhAnalysisdStatsAgentsItemAgentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsAgentsItemAgentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsAgentsItemAgentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsAgentsItemAgentsInner(val *WazuhAnalysisdStatsAgentsItemAgentsInner) *NullableWazuhAnalysisdStatsAgentsItemAgentsInner {
	return &NullableWazuhAnalysisdStatsAgentsItemAgentsInner{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsAgentsItemAgentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsAgentsItemAgentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
