...
// checks if the AllItemsResponseClusterNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseClusterNodes{}

// AllItemsResponseClusterNodes struct for AllItemsResponseClusterNodes
...
type _AllItemsResponseClusterNodes AllItemsResponseClusterNodes
...
func NewAllItemsResponseClusterNodes(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []ClusterNode) *AllItemsResponseClusterNodes {
	this := AllItemsResponseClusterNodes{}
...
func (o AllItemsResponseClusterNodes) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseClusterNodes) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseClusterNodes) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseClusterNodes := _AllItemsResponseClusterNodes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseClusterNodes)

	if err != nil {
		return err
	}

	*o = AllItemsResponseClusterNodes(varAllItemsResponseClusterNodes)

	return err
}

type NullableAllItemsResponseClusterNodes struct {
	value *AllItemsResponseClusterNodes
	isSet bool
}

func (v NullableAllItemsResponseClusterNodes) Get() *AllItemsResponseClusterNodes {
	return v.value
}

func (v *NullableAllItemsResponseClusterNodes) Set(val *AllItemsResponseClusterNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseClusterNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseClusterNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseClusterNodes(val *AllItemsResponseClusterNodes) *NullableAllItemsResponseClusterNodes {
	return &NullableAllItemsResponseClusterNodes{value: val, isSet: true}
}

func (v NullableAllItemsResponseClusterNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseClusterNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
