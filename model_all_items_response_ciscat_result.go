...
// checks if the AllItemsResponseCiscatResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseCiscatResult{}

// AllItemsResponseCiscatResult struct for AllItemsResponseCiscatResult
...
type _AllItemsResponseCiscatResult AllItemsResponseCiscatResult
...
func NewAllItemsResponseCiscatResult(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []CiscatResults) *AllItemsResponseCiscatResult {
	this := AllItemsResponseCiscatResult{}
...
func (o AllItemsResponseCiscatResult) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseCiscatResult) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseCiscatResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseCiscatResult := _AllItemsResponseCiscatResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseCiscatResult)

	if err != nil {
		return err
	}

	*o = AllItemsResponseCiscatResult(varAllItemsResponseCiscatResult)

	return err
}

type NullableAllItemsResponseCiscatResult struct {
	value *AllItemsResponseCiscatResult
	isSet bool
}

func (v NullableAllItemsResponseCiscatResult) Get() *AllItemsResponseCiscatResult {
	return v.value
}

func (v *NullableAllItemsResponseCiscatResult) Set(val *AllItemsResponseCiscatResult) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseCiscatResult) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseCiscatResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseCiscatResult(val *AllItemsResponseCiscatResult) *NullableAllItemsResponseCiscatResult {
	return &NullableAllItemsResponseCiscatResult{value: val, isSet: true}
}

func (v NullableAllItemsResponseCiscatResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseCiscatResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
