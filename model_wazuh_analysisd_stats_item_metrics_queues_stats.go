...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesStats{}

// WazuhAnalysisdStatsItemMetricsQueuesStats struct for WazuhAnalysisdStatsItemMetricsQueuesStats
type WazuhAnalysisdStatsItemMetricsQueuesStats struct {
...
func NewWazuhAnalysisdStatsItemMetricsQueuesStats() *WazuhAnalysisdStatsItemMetricsQueuesStats {
	this := WazuhAnalysisdStatsItemMetricsQueuesStats{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesStats) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesStats) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesStats struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesStats
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesStats) Get() *WazuhAnalysisdStatsItemMetricsQueuesStats {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesStats) Set(val *WazuhAnalysisdStatsItemMetricsQueuesStats) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesStats) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesStats(val *WazuhAnalysisdStatsItemMetricsQueuesStats) *NullableWazuhAnalysisdStatsItemMetricsQueuesStats {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesStats{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
