...
// checks if the AllItemsResponseAgents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseAgents{}

// AllItemsResponseAgents struct for AllItemsResponseAgents
...
type _AllItemsResponseAgents AllItemsResponseAgents
...
func (o AllItemsResponseAgents) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseAgents) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseAgents) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseAgents := _AllItemsResponseAgents{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseAgents)

	if err != nil {
		return err
	}

	*o = AllItemsResponseAgents(varAllItemsResponseAgents)

	return err
}

type NullableAllItemsResponseAgents struct {
	value *AllItemsResponseAgents
	isSet bool
}

func (v NullableAllItemsResponseAgents) Get() *AllItemsResponseAgents {
	return v.value
}

func (v *NullableAllItemsResponseAgents) Set(val *AllItemsResponseAgents) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseAgents) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseAgents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseAgents(val *AllItemsResponseAgents) *NullableAllItemsResponseAgents {
	return &NullableAllItemsResponseAgents{value: val, isSet: true}
}

func (v NullableAllItemsResponseAgents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseAgents) UnmarshalJSON(src []byte) error {
	v.isSet = true
