...
// checks if the AllItemsResponsePolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponsePolicies{}

// AllItemsResponsePolicies struct for AllItemsResponsePolicies
type AllItemsResponsePolicies struct {
	...
	AffectedItems []AllItemsResponsePoliciesAllOfAffectedItems `json:"affected_items"`
}

type _AllItemsResponsePolicies AllItemsResponsePolicies
...
func (o *AllItemsResponsePolicies) GetAffectedItems() []AllItemsResponsePoliciesAllOfAffectedItems {
	if o == nil {
		var ret []AllItemsResponsePoliciesAllOfAffectedItems
		return ret
	}
...
func (o AllItemsResponsePolicies) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponsePolicies) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponsePolicies) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponsePolicies := _AllItemsResponsePolicies{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponsePolicies)

	if err != nil {
		return err
	}

	*o = AllItemsResponsePolicies(varAllItemsResponsePolicies)

	return err
}

type NullableAllItemsResponsePolicies struct {
	value *AllItemsResponsePolicies
	isSet bool
}

func (v NullableAllItemsResponsePolicies) Get() *AllItemsResponsePolicies {
	return v.value
}

func (v *NullableAllItemsResponsePolicies) Set(val *AllItemsResponsePolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponsePolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponsePolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponsePolicies(val *AllItemsResponsePolicies) *NullableAllItemsResponsePolicies {
	return &NullableAllItemsResponsePolicies{value: val, isSet: true}
}

func (v NullableAllItemsResponsePolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponsePolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
