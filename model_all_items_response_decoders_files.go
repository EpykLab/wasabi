...
// checks if the AllItemsResponseDecodersFiles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseDecodersFiles{}

// AllItemsResponseDecodersFiles struct for AllItemsResponseDecodersFiles
...
type _AllItemsResponseDecodersFiles AllItemsResponseDecodersFiles
...
func NewAllItemsResponseDecodersFiles(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []DecoderFile) *AllItemsResponseDecodersFiles {
	this := AllItemsResponseDecodersFiles{}
...
func (o AllItemsResponseDecodersFiles) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseDecodersFiles) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseDecodersFiles) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseDecodersFiles := _AllItemsResponseDecodersFiles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseDecodersFiles)

	if err != nil {
		return err
	}

	*o = AllItemsResponseDecodersFiles(varAllItemsResponseDecodersFiles)

	return err
}

type NullableAllItemsResponseDecodersFiles struct {
	value *AllItemsResponseDecodersFiles
	isSet bool
}

func (v NullableAllItemsResponseDecodersFiles) Get() *AllItemsResponseDecodersFiles {
	return v.value
}

func (v *NullableAllItemsResponseDecodersFiles) Set(val *AllItemsResponseDecodersFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseDecodersFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseDecodersFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseDecodersFiles(val *AllItemsResponseDecodersFiles) *NullableAllItemsResponseDecodersFiles {
	return &NullableAllItemsResponseDecodersFiles{value: val, isSet: true}
}

func (v NullableAllItemsResponseDecodersFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseDecodersFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
