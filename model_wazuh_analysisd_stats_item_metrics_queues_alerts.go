...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesAlerts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesAlerts{}

// WazuhAnalysisdStatsItemMetricsQueuesAlerts struct for WazuhAnalysisdStatsItemMetricsQueuesAlerts
type WazuhAnalysisdStatsItemMetricsQueuesAlerts struct {
	// Alerts messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesAlerts() *WazuhAnalysisdStatsItemMetricsQueuesAlerts {
	this := WazuhAnalysisdStatsItemMetricsQueuesAlerts{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesAlerts) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesAlerts) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesAlerts
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) Get() *WazuhAnalysisdStatsItemMetricsQueuesAlerts {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) Set(val *WazuhAnalysisdStatsItemMetricsQueuesAlerts) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesAlerts(val *WazuhAnalysisdStatsItemMetricsQueuesAlerts) *NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesAlerts) UnmarshalJSON(src []byte) error {
	v.isSet = true
