...
// checks if the AllItemsResponseSyscheckResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSyscheckResult{}

// AllItemsResponseSyscheckResult struct for AllItemsResponseSyscheckResult
...
type _AllItemsResponseSyscheckResult AllItemsResponseSyscheckResult
...
func NewAllItemsResponseSyscheckResult(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SyscheckDatabase) *AllItemsResponseSyscheckResult {
	this := AllItemsResponseSyscheckResult{}
...
func (o AllItemsResponseSyscheckResult) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSyscheckResult) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSyscheckResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSyscheckResult := _AllItemsResponseSyscheckResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSyscheckResult)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSyscheckResult(varAllItemsResponseSyscheckResult)

	return err
}

type NullableAllItemsResponseSyscheckResult struct {
	value *AllItemsResponseSyscheckResult
	isSet bool
}

func (v NullableAllItemsResponseSyscheckResult) Get() *AllItemsResponseSyscheckResult {
	return v.value
}

func (v *NullableAllItemsResponseSyscheckResult) Set(val *AllItemsResponseSyscheckResult) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSyscheckResult) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSyscheckResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSyscheckResult(val *AllItemsResponseSyscheckResult) *NullableAllItemsResponseSyscheckResult {
	return &NullableAllItemsResponseSyscheckResult{value: val, isSet: true}
}

func (v NullableAllItemsResponseSyscheckResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSyscheckResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
