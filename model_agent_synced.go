...
// checks if the AgentSynced type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSynced{}

// AgentSynced struct for AgentSynced
...
func (o AgentSynced) MarshalJSON() ([]byte, error) {
...
func (o AgentSynced) ToMap() (map[string]interface{}, error) {
...
type NullableAgentSynced struct {
	value *AgentSynced
	isSet bool
}

func (v NullableAgentSynced) Get() *AgentSynced {
	return v.value
}

func (v *NullableAgentSynced) Set(val *AgentSynced) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSynced) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSynced) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSynced(val *AgentSynced) *NullableAgentSynced {
	return &NullableAgentSynced{value: val, isSet: true}
}

func (v NullableAgentSynced) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSynced) UnmarshalJSON(src []byte) error {
	v.isSet = true
