...
// checks if the AllItemsResponseLastScan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseLastScan{}

// AllItemsResponseLastScan struct for AllItemsResponseLastScan
...
type _AllItemsResponseLastScan AllItemsResponseLastScan
...
func (o AllItemsResponseLastScan) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseLastScan) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseLastScan) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseLastScan := _AllItemsResponseLastScan{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseLastScan)

	if err != nil {
		return err
	}

	*o = AllItemsResponseLastScan(varAllItemsResponseLastScan)

	return err
}

type NullableAllItemsResponseLastScan struct {
	value *AllItemsResponseLastScan
	isSet bool
}

func (v NullableAllItemsResponseLastScan) Get() *AllItemsResponseLastScan {
	return v.value
}

func (v *NullableAllItemsResponseLastScan) Set(val *AllItemsResponseLastScan) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseLastScan) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseLastScan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseLastScan(val *AllItemsResponseLastScan) *NullableAllItemsResponseLastScan {
	return &NullableAllItemsResponseLastScan{value: val, isSet: true}
}

func (v NullableAllItemsResponseLastScan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseLastScan) UnmarshalJSON(src []byte) error {
	v.isSet = true
