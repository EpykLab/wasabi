...
// checks if the AllItemsResponseSCADatabase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSCADatabase{}

// AllItemsResponseSCADatabase struct for AllItemsResponseSCADatabase
...
type _AllItemsResponseSCADatabase AllItemsResponseSCADatabase
...
func NewAllItemsResponseSCADatabase(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SCADatabase) *AllItemsResponseSCADatabase {
	this := AllItemsResponseSCADatabase{}
...
func (o AllItemsResponseSCADatabase) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSCADatabase) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSCADatabase) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSCADatabase := _AllItemsResponseSCADatabase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSCADatabase)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSCADatabase(varAllItemsResponseSCADatabase)

	return err
}

type NullableAllItemsResponseSCADatabase struct {
	value *AllItemsResponseSCADatabase
	isSet bool
}

func (v NullableAllItemsResponseSCADatabase) Get() *AllItemsResponseSCADatabase {
	return v.value
}

func (v *NullableAllItemsResponseSCADatabase) Set(val *AllItemsResponseSCADatabase) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSCADatabase) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSCADatabase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSCADatabase(val *AllItemsResponseSCADatabase) *NullableAllItemsResponseSCADatabase {
	return &NullableAllItemsResponseSCADatabase{value: val, isSet: true}
}

func (v NullableAllItemsResponseSCADatabase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSCADatabase) UnmarshalJSON(src []byte) error {
	v.isSet = true
