...
// checks if the AllItemsResponseLists type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseLists{}

// AllItemsResponseLists struct for AllItemsResponseLists
...
type _AllItemsResponseLists AllItemsResponseLists
...
func (o AllItemsResponseLists) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseLists) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseLists) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseLists := _AllItemsResponseLists{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseLists)

	if err != nil {
		return err
	}

	*o = AllItemsResponseLists(varAllItemsResponseLists)

	return err
}

type NullableAllItemsResponseLists struct {
	value *AllItemsResponseLists
	isSet bool
}

func (v NullableAllItemsResponseLists) Get() *AllItemsResponseLists {
	return v.value
}

func (v *NullableAllItemsResponseLists) Set(val *AllItemsResponseLists) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseLists) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseLists) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseLists(val *AllItemsResponseLists) *NullableAllItemsResponseLists {
	return &NullableAllItemsResponseLists{value: val, isSet: true}
}

func (v NullableAllItemsResponseLists) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseLists) UnmarshalJSON(src []byte) error {
	v.isSet = true
