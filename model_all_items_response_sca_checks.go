...
// checks if the AllItemsResponseSCAChecks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSCAChecks{}

// AllItemsResponseSCAChecks struct for AllItemsResponseSCAChecks
...
type _AllItemsResponseSCAChecks AllItemsResponseSCAChecks
...
func NewAllItemsResponseSCAChecks(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SCAChecks) *AllItemsResponseSCAChecks {
	this := AllItemsResponseSCAChecks{}
...
func (o AllItemsResponseSCAChecks) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSCAChecks) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSCAChecks) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSCAChecks := _AllItemsResponseSCAChecks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSCAChecks)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSCAChecks(varAllItemsResponseSCAChecks)

	return err
}

type NullableAllItemsResponseSCAChecks struct {
	value *AllItemsResponseSCAChecks
	isSet bool
}

func (v NullableAllItemsResponseSCAChecks) Get() *AllItemsResponseSCAChecks {
	return v.value
}

func (v *NullableAllItemsResponseSCAChecks) Set(val *AllItemsResponseSCAChecks) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSCAChecks) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSCAChecks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSCAChecks(val *AllItemsResponseSCAChecks) *NullableAllItemsResponseSCAChecks {
	return &NullableAllItemsResponseSCAChecks{value: val, isSet: true}
}

func (v NullableAllItemsResponseSCAChecks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSCAChecks) UnmarshalJSON(src []byte) error {
	v.isSet = true
