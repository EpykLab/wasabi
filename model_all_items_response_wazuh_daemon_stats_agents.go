...
// checks if the AllItemsResponseWazuhDaemonStatsAgents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseWazuhDaemonStatsAgents{}

// AllItemsResponseWazuhDaemonStatsAgents struct for AllItemsResponseWazuhDaemonStatsAgents
type AllItemsResponseWazuhDaemonStatsAgents struct {
	...
	AffectedItems []AllItemsResponseWazuhDaemonStatsAgentsAllOfAffectedItems `json:"affected_items"`
}

type _AllItemsResponseWazuhDaemonStatsAgents AllItemsResponseWazuhDaemonStatsAgents
...
func NewAllItemsResponseWazuhDaemonStatsAgents(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []AllItemsResponseWazuhDaemonStatsAgentsAllOfAffectedItems) *AllItemsResponseWazuhDaemonStatsAgents {
	this := AllItemsResponseWazuhDaemonStatsAgents{}
...
func (o *AllItemsResponseWazuhDaemonStatsAgents) GetAffectedItems() []AllItemsResponseWazuhDaemonStatsAgentsAllOfAffectedItems {
	if o == nil {
		var ret []AllItemsResponseWazuhDaemonStatsAgentsAllOfAffectedItems
		return ret
	}
...
func (o AllItemsResponseWazuhDaemonStatsAgents) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseWazuhDaemonStatsAgents) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseWazuhDaemonStatsAgents) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseWazuhDaemonStatsAgents := _AllItemsResponseWazuhDaemonStatsAgents{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseWazuhDaemonStatsAgents)

	if err != nil {
		return err
	}

	*o = AllItemsResponseWazuhDaemonStatsAgents(varAllItemsResponseWazuhDaemonStatsAgents)

	return err
}

type NullableAllItemsResponseWazuhDaemonStatsAgents struct {
	value *AllItemsResponseWazuhDaemonStatsAgents
	isSet bool
}

func (v NullableAllItemsResponseWazuhDaemonStatsAgents) Get() *AllItemsResponseWazuhDaemonStatsAgents {
	return v.value
}

func (v *NullableAllItemsResponseWazuhDaemonStatsAgents) Set(val *AllItemsResponseWazuhDaemonStatsAgents) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseWazuhDaemonStatsAgents) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseWazuhDaemonStatsAgents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseWazuhDaemonStatsAgents(val *AllItemsResponseWazuhDaemonStatsAgents) *NullableAllItemsResponseWazuhDaemonStatsAgents {
	return &NullableAllItemsResponseWazuhDaemonStatsAgents{value: val, isSet: true}
}

func (v NullableAllItemsResponseWazuhDaemonStatsAgents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseWazuhDaemonStatsAgents) UnmarshalJSON(src []byte) error {
	v.isSet = true
