...
// checks if the ClusterNodeBasic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterNodeBasic{}

// ClusterNodeBasic struct for ClusterNodeBasic
...
func (o ClusterNodeBasic) MarshalJSON() ([]byte, error) {
...
func (o ClusterNodeBasic) ToMap() (map[string]interface{}, error) {
...
type NullableClusterNodeBasic struct {
	value *ClusterNodeBasic
	isSet bool
}

func (v NullableClusterNodeBasic) Get() *ClusterNodeBasic {
	return v.value
}

func (v *NullableClusterNodeBasic) Set(val *ClusterNodeBasic) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterNodeBasic) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterNodeBasic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterNodeBasic(val *ClusterNodeBasic) *NullableClusterNodeBasic {
	return &NullableClusterNodeBasic{value: val, isSet: true}
}

func (v NullableClusterNodeBasic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterNodeBasic) UnmarshalJSON(src []byte) error {
	v.isSet = true
