...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesArchives type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesArchives{}

// WazuhAnalysisdStatsItemMetricsQueuesArchives struct for WazuhAnalysisdStatsItemMetricsQueuesArchives
type WazuhAnalysisdStatsItemMetricsQueuesArchives struct {
	// Archives messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesArchives() *WazuhAnalysisdStatsItemMetricsQueuesArchives {
	this := WazuhAnalysisdStatsItemMetricsQueuesArchives{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesArchives) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesArchives) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesArchives struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesArchives
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) Get() *WazuhAnalysisdStatsItemMetricsQueuesArchives {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) Set(val *WazuhAnalysisdStatsItemMetricsQueuesArchives) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesArchives(val *WazuhAnalysisdStatsItemMetricsQueuesArchives) *NullableWazuhAnalysisdStatsItemMetricsQueuesArchives {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesArchives{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesArchives) UnmarshalJSON(src []byte) error {
	v.isSet = true
