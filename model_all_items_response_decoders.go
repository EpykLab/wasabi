...
// checks if the AllItemsResponseDecoders type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseDecoders{}

// AllItemsResponseDecoders struct for AllItemsResponseDecoders
...
type _AllItemsResponseDecoders AllItemsResponseDecoders
...
func (o AllItemsResponseDecoders) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseDecoders) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseDecoders) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseDecoders := _AllItemsResponseDecoders{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseDecoders)

	if err != nil {
		return err
	}

	*o = AllItemsResponseDecoders(varAllItemsResponseDecoders)

	return err
}

type NullableAllItemsResponseDecoders struct {
	value *AllItemsResponseDecoders
	isSet bool
}

func (v NullableAllItemsResponseDecoders) Get() *AllItemsResponseDecoders {
	return v.value
}

func (v *NullableAllItemsResponseDecoders) Set(val *AllItemsResponseDecoders) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseDecoders) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseDecoders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseDecoders(val *AllItemsResponseDecoders) *NullableAllItemsResponseDecoders {
	return &NullableAllItemsResponseDecoders{value: val, isSet: true}
}

func (v NullableAllItemsResponseDecoders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseDecoders) UnmarshalJSON(src []byte) error {
	v.isSet = true
