...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesFirewall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesFirewall{}

// WazuhAnalysisdStatsItemMetricsQueuesFirewall struct for WazuhAnalysisdStatsItemMetricsQueuesFirewall
type WazuhAnalysisdStatsItemMetricsQueuesFirewall struct {
	// Firewall messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesFirewall() *WazuhAnalysisdStatsItemMetricsQueuesFirewall {
	this := WazuhAnalysisdStatsItemMetricsQueuesFirewall{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesFirewall) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesFirewall) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesFirewall
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) Get() *WazuhAnalysisdStatsItemMetricsQueuesFirewall {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) Set(val *WazuhAnalysisdStatsItemMetricsQueuesFirewall) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesFirewall(val *WazuhAnalysisdStatsItemMetricsQueuesFirewall) *NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFirewall) UnmarshalJSON(src []byte) error {
	v.isSet = true
