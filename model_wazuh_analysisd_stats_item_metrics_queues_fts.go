...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesFts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesFts{}

// WazuhAnalysisdStatsItemMetricsQueuesFts struct for WazuhAnalysisdStatsItemMetricsQueuesFts
type WazuhAnalysisdStatsItemMetricsQueuesFts struct {
	// FTS messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesFts() *WazuhAnalysisdStatsItemMetricsQueuesFts {
	this := WazuhAnalysisdStatsItemMetricsQueuesFts{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesFts) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesFts) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesFts struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesFts
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFts) Get() *WazuhAnalysisdStatsItemMetricsQueuesFts {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFts) Set(val *WazuhAnalysisdStatsItemMetricsQueuesFts) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFts) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesFts(val *WazuhAnalysisdStatsItemMetricsQueuesFts) *NullableWazuhAnalysisdStatsItemMetricsQueuesFts {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesFts{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesFts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesFts) UnmarshalJSON(src []byte) error {
	v.isSet = true
