...
// checks if the AllItemsResponseAgentsKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseAgentsKeys{}

// AllItemsResponseAgentsKeys struct for AllItemsResponseAgentsKeys
...
type _AllItemsResponseAgentsKeys AllItemsResponseAgentsKeys
...
func NewAllItemsResponseAgentsKeys(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []AgentIdKey) *AllItemsResponseAgentsKeys {
	this := AllItemsResponseAgentsKeys{}
...
func (o AllItemsResponseAgentsKeys) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseAgentsKeys) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseAgentsKeys) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseAgentsKeys := _AllItemsResponseAgentsKeys{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseAgentsKeys)

	if err != nil {
		return err
	}

	*o = AllItemsResponseAgentsKeys(varAllItemsResponseAgentsKeys)

	return err
}

type NullableAllItemsResponseAgentsKeys struct {
	value *AllItemsResponseAgentsKeys
	isSet bool
}

func (v NullableAllItemsResponseAgentsKeys) Get() *AllItemsResponseAgentsKeys {
	return v.value
}

func (v *NullableAllItemsResponseAgentsKeys) Set(val *AllItemsResponseAgentsKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseAgentsKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseAgentsKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseAgentsKeys(val *AllItemsResponseAgentsKeys) *NullableAllItemsResponseAgentsKeys {
	return &NullableAllItemsResponseAgentsKeys{value: val, isSet: true}
}

func (v NullableAllItemsResponseAgentsKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseAgentsKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
