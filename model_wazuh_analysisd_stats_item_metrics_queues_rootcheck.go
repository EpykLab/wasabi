...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesRootcheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesRootcheck{}

// WazuhAnalysisdStatsItemMetricsQueuesRootcheck struct for WazuhAnalysisdStatsItemMetricsQueuesRootcheck
type WazuhAnalysisdStatsItemMetricsQueuesRootcheck struct {
	// Rootcheck messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesRootcheck() *WazuhAnalysisdStatsItemMetricsQueuesRootcheck {
	this := WazuhAnalysisdStatsItemMetricsQueuesRootcheck{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesRootcheck) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesRootcheck) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesRootcheck
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) Get() *WazuhAnalysisdStatsItemMetricsQueuesRootcheck {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) Set(val *WazuhAnalysisdStatsItemMetricsQueuesRootcheck) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck(val *WazuhAnalysisdStatsItemMetricsQueuesRootcheck) *NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesRootcheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
