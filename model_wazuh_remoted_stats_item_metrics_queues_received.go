...
// checks if the WazuhRemotedStatsItemMetricsQueuesReceived type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhRemotedStatsItemMetricsQueuesReceived{}

// WazuhRemotedStatsItemMetricsQueuesReceived struct for WazuhRemotedStatsItemMetricsQueuesReceived
type WazuhRemotedStatsItemMetricsQueuesReceived struct {
	// Received messages queue size
...
func NewWazuhRemotedStatsItemMetricsQueuesReceived() *WazuhRemotedStatsItemMetricsQueuesReceived {
	this := WazuhRemotedStatsItemMetricsQueuesReceived{}
	return &this
}
...
func (o WazuhRemotedStatsItemMetricsQueuesReceived) MarshalJSON() ([]byte, error) {
...
func (o WazuhRemotedStatsItemMetricsQueuesReceived) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhRemotedStatsItemMetricsQueuesReceived struct {
	value *WazuhRemotedStatsItemMetricsQueuesReceived
	isSet bool
}

func (v NullableWazuhRemotedStatsItemMetricsQueuesReceived) Get() *WazuhRemotedStatsItemMetricsQueuesReceived {
	return v.value
}

func (v *NullableWazuhRemotedStatsItemMetricsQueuesReceived) Set(val *WazuhRemotedStatsItemMetricsQueuesReceived) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhRemotedStatsItemMetricsQueuesReceived) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhRemotedStatsItemMetricsQueuesReceived) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhRemotedStatsItemMetricsQueuesReceived(val *WazuhRemotedStatsItemMetricsQueuesReceived) *NullableWazuhRemotedStatsItemMetricsQueuesReceived {
	return &NullableWazuhRemotedStatsItemMetricsQueuesReceived{value: val, isSet: true}
}

func (v NullableWazuhRemotedStatsItemMetricsQueuesReceived) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhRemotedStatsItemMetricsQueuesReceived) UnmarshalJSON(src []byte) error {
	v.isSet = true
