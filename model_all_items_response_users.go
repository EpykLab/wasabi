...
// checks if the AllItemsResponseUsers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseUsers{}

// AllItemsResponseUsers struct for AllItemsResponseUsers
...
type _AllItemsResponseUsers AllItemsResponseUsers
...
func (o AllItemsResponseUsers) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseUsers) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseUsers) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseUsers := _AllItemsResponseUsers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseUsers)

	if err != nil {
		return err
	}

	*o = AllItemsResponseUsers(varAllItemsResponseUsers)

	return err
}

type NullableAllItemsResponseUsers struct {
	value *AllItemsResponseUsers
	isSet bool
}

func (v NullableAllItemsResponseUsers) Get() *AllItemsResponseUsers {
	return v.value
}

func (v *NullableAllItemsResponseUsers) Set(val *AllItemsResponseUsers) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseUsers) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseUsers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseUsers(val *AllItemsResponseUsers) *NullableAllItemsResponseUsers {
	return &NullableAllItemsResponseUsers{value: val, isSet: true}
}

func (v NullableAllItemsResponseUsers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseUsers) UnmarshalJSON(src []byte) error {
	v.isSet = true
