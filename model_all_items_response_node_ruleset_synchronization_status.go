...
// checks if the AllItemsResponseNodeRulesetSynchronizationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseNodeRulesetSynchronizationStatus{}

// AllItemsResponseNodeRulesetSynchronizationStatus struct for AllItemsResponseNodeRulesetSynchronizationStatus
...
type _AllItemsResponseNodeRulesetSynchronizationStatus AllItemsResponseNodeRulesetSynchronizationStatus
...
func NewAllItemsResponseNodeRulesetSynchronizationStatus(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []NodeRulesetSyncStatus) *AllItemsResponseNodeRulesetSynchronizationStatus {
	this := AllItemsResponseNodeRulesetSynchronizationStatus{}
...
func (o AllItemsResponseNodeRulesetSynchronizationStatus) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseNodeRulesetSynchronizationStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseNodeRulesetSynchronizationStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseNodeRulesetSynchronizationStatus := _AllItemsResponseNodeRulesetSynchronizationStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseNodeRulesetSynchronizationStatus)

	if err != nil {
		return err
	}

	*o = AllItemsResponseNodeRulesetSynchronizationStatus(varAllItemsResponseNodeRulesetSynchronizationStatus)

	return err
}

type NullableAllItemsResponseNodeRulesetSynchronizationStatus struct {
	value *AllItemsResponseNodeRulesetSynchronizationStatus
	isSet bool
}

func (v NullableAllItemsResponseNodeRulesetSynchronizationStatus) Get() *AllItemsResponseNodeRulesetSynchronizationStatus {
	return v.value
}

func (v *NullableAllItemsResponseNodeRulesetSynchronizationStatus) Set(val *AllItemsResponseNodeRulesetSynchronizationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseNodeRulesetSynchronizationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseNodeRulesetSynchronizationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseNodeRulesetSynchronizationStatus(val *AllItemsResponseNodeRulesetSynchronizationStatus) *NullableAllItemsResponseNodeRulesetSynchronizationStatus {
	return &NullableAllItemsResponseNodeRulesetSynchronizationStatus{value: val, isSet: true}
}

func (v NullableAllItemsResponseNodeRulesetSynchronizationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseNodeRulesetSynchronizationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
