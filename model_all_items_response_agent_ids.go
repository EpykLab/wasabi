...
// checks if the AllItemsResponseAgentIDs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseAgentIDs{}

// AllItemsResponseAgentIDs struct for AllItemsResponseAgentIDs
...
type _AllItemsResponseAgentIDs AllItemsResponseAgentIDs
...
func (o AllItemsResponseAgentIDs) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseAgentIDs) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseAgentIDs) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseAgentIDs := _AllItemsResponseAgentIDs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseAgentIDs)

	if err != nil {
		return err
	}

	*o = AllItemsResponseAgentIDs(varAllItemsResponseAgentIDs)

	return err
}

type NullableAllItemsResponseAgentIDs struct {
	value *AllItemsResponseAgentIDs
	isSet bool
}

func (v NullableAllItemsResponseAgentIDs) Get() *AllItemsResponseAgentIDs {
	return v.value
}

func (v *NullableAllItemsResponseAgentIDs) Set(val *AllItemsResponseAgentIDs) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseAgentIDs) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseAgentIDs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseAgentIDs(val *AllItemsResponseAgentIDs) *NullableAllItemsResponseAgentIDs {
	return &NullableAllItemsResponseAgentIDs{value: val, isSet: true}
}

func (v NullableAllItemsResponseAgentIDs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseAgentIDs) UnmarshalJSON(src []byte) error {
	v.isSet = true
