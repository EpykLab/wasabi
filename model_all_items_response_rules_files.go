...
// checks if the AllItemsResponseRulesFiles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseRulesFiles{}

// AllItemsResponseRulesFiles struct for AllItemsResponseRulesFiles
...
type _AllItemsResponseRulesFiles AllItemsResponseRulesFiles
...
func NewAllItemsResponseRulesFiles(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []RuleFile) *AllItemsResponseRulesFiles {
	this := AllItemsResponseRulesFiles{}
...
func (o AllItemsResponseRulesFiles) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseRulesFiles) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseRulesFiles) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseRulesFiles := _AllItemsResponseRulesFiles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseRulesFiles)

	if err != nil {
		return err
	}

	*o = AllItemsResponseRulesFiles(varAllItemsResponseRulesFiles)

	return err
}

type NullableAllItemsResponseRulesFiles struct {
	value *AllItemsResponseRulesFiles
	isSet bool
}

func (v NullableAllItemsResponseRulesFiles) Get() *AllItemsResponseRulesFiles {
	return v.value
}

func (v *NullableAllItemsResponseRulesFiles) Set(val *AllItemsResponseRulesFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseRulesFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseRulesFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseRulesFiles(val *AllItemsResponseRulesFiles) *NullableAllItemsResponseRulesFiles {
	return &NullableAllItemsResponseRulesFiles{value: val, isSet: true}
}

func (v NullableAllItemsResponseRulesFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseRulesFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
