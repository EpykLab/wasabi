...
// checks if the AllItemsResponseWazuhStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseWazuhStats{}

// AllItemsResponseWazuhStats struct for AllItemsResponseWazuhStats
type AllItemsResponseWazuhStats struct {
	...
	AffectedItems []AllItemsResponseWazuhStatsAllOfAffectedItems `json:"affected_items"`
}

type _AllItemsResponseWazuhStats AllItemsResponseWazuhStats
...
func NewAllItemsResponseWazuhStats(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []AllItemsResponseWazuhStatsAllOfAffectedItems) *AllItemsResponseWazuhStats {
	this := AllItemsResponseWazuhStats{}
...
func (o *AllItemsResponseWazuhStats) GetAffectedItems() []AllItemsResponseWazuhStatsAllOfAffectedItems {
	if o == nil {
		var ret []AllItemsResponseWazuhStatsAllOfAffectedItems
		return ret
	}
...
func (o AllItemsResponseWazuhStats) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseWazuhStats) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseWazuhStats) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseWazuhStats := _AllItemsResponseWazuhStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseWazuhStats)

	if err != nil {
		return err
	}

	*o = AllItemsResponseWazuhStats(varAllItemsResponseWazuhStats)

	return err
}

type NullableAllItemsResponseWazuhStats struct {
	value *AllItemsResponseWazuhStats
	isSet bool
}

func (v NullableAllItemsResponseWazuhStats) Get() *AllItemsResponseWazuhStats {
	return v.value
}

func (v *NullableAllItemsResponseWazuhStats) Set(val *AllItemsResponseWazuhStats) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseWazuhStats) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseWazuhStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseWazuhStats(val *AllItemsResponseWazuhStats) *NullableAllItemsResponseWazuhStats {
	return &NullableAllItemsResponseWazuhStats{value: val, isSet: true}
}

func (v NullableAllItemsResponseWazuhStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseWazuhStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
