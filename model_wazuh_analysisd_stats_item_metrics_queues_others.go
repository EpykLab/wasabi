...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesOthers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesOthers{}

// WazuhAnalysisdStatsItemMetricsQueuesOthers struct for WazuhAnalysisdStatsItemMetricsQueuesOthers
type WazuhAnalysisdStatsItemMetricsQueuesOthers struct {
	// Other events messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesOthers() *WazuhAnalysisdStatsItemMetricsQueuesOthers {
	this := WazuhAnalysisdStatsItemMetricsQueuesOthers{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesOthers) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesOthers) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesOthers struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesOthers
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) Get() *WazuhAnalysisdStatsItemMetricsQueuesOthers {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) Set(val *WazuhAnalysisdStatsItemMetricsQueuesOthers) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesOthers(val *WazuhAnalysisdStatsItemMetricsQueuesOthers) *NullableWazuhAnalysisdStatsItemMetricsQueuesOthers {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesOthers{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesOthers) UnmarshalJSON(src []byte) error {
	v.isSet = true
