...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesDbsync type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesDbsync{}

// WazuhAnalysisdStatsItemMetricsQueuesDbsync struct for WazuhAnalysisdStatsItemMetricsQueuesDbsync
type WazuhAnalysisdStatsItemMetricsQueuesDbsync struct {
	// DBsync messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesDbsync() *WazuhAnalysisdStatsItemMetricsQueuesDbsync {
	this := WazuhAnalysisdStatsItemMetricsQueuesDbsync{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesDbsync) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesDbsync) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesDbsync
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) Get() *WazuhAnalysisdStatsItemMetricsQueuesDbsync {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) Set(val *WazuhAnalysisdStatsItemMetricsQueuesDbsync) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesDbsync(val *WazuhAnalysisdStatsItemMetricsQueuesDbsync) *NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesDbsync) UnmarshalJSON(src []byte) error {
	v.isSet = true
