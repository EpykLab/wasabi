...
// checks if the AllItemsResponseGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseGroups{}

// AllItemsResponseGroups struct for AllItemsResponseGroups
...
type _AllItemsResponseGroups AllItemsResponseGroups
...
func (o AllItemsResponseGroups) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseGroups) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseGroups) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseGroups := _AllItemsResponseGroups{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseGroups)

	if err != nil {
		return err
	}

	*o = AllItemsResponseGroups(varAllItemsResponseGroups)

	return err
}

type NullableAllItemsResponseGroups struct {
	value *AllItemsResponseGroups
	isSet bool
}

func (v NullableAllItemsResponseGroups) Get() *AllItemsResponseGroups {
	return v.value
}

func (v *NullableAllItemsResponseGroups) Set(val *AllItemsResponseGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseGroups(val *AllItemsResponseGroups) *NullableAllItemsResponseGroups {
	return &NullableAllItemsResponseGroups{value: val, isSet: true}
}

func (v NullableAllItemsResponseGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
