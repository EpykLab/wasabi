...
// checks if the AllItemsResponseRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseRoles{}

// AllItemsResponseRoles struct for AllItemsResponseRoles
...
type _AllItemsResponseRoles AllItemsResponseRoles
...
func (o AllItemsResponseRoles) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseRoles) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseRoles) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseRoles := _AllItemsResponseRoles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseRoles)

	if err != nil {
		return err
	}

	*o = AllItemsResponseRoles(varAllItemsResponseRoles)

	return err
}

type NullableAllItemsResponseRoles struct {
	value *AllItemsResponseRoles
	isSet bool
}

func (v NullableAllItemsResponseRoles) Get() *AllItemsResponseRoles {
	return v.value
}

func (v *NullableAllItemsResponseRoles) Set(val *AllItemsResponseRoles) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseRoles) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseRoles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseRoles(val *AllItemsResponseRoles) *NullableAllItemsResponseRoles {
	return &NullableAllItemsResponseRoles{value: val, isSet: true}
}

func (v NullableAllItemsResponseRoles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseRoles) UnmarshalJSON(src []byte) error {
	v.isSet = true
