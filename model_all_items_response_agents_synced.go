...
// checks if the AllItemsResponseAgentsSynced type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseAgentsSynced{}

// AllItemsResponseAgentsSynced struct for AllItemsResponseAgentsSynced
...
type _AllItemsResponseAgentsSynced AllItemsResponseAgentsSynced
...
func NewAllItemsResponseAgentsSynced(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []AgentSynced) *AllItemsResponseAgentsSynced {
	this := AllItemsResponseAgentsSynced{}
...
func (o AllItemsResponseAgentsSynced) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseAgentsSynced) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseAgentsSynced) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseAgentsSynced := _AllItemsResponseAgentsSynced{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseAgentsSynced)

	if err != nil {
		return err
	}

	*o = AllItemsResponseAgentsSynced(varAllItemsResponseAgentsSynced)

	return err
}

type NullableAllItemsResponseAgentsSynced struct {
	value *AllItemsResponseAgentsSynced
	isSet bool
}

func (v NullableAllItemsResponseAgentsSynced) Get() *AllItemsResponseAgentsSynced {
	return v.value
}

func (v *NullableAllItemsResponseAgentsSynced) Set(val *AllItemsResponseAgentsSynced) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseAgentsSynced) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseAgentsSynced) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseAgentsSynced(val *AllItemsResponseAgentsSynced) *NullableAllItemsResponseAgentsSynced {
	return &NullableAllItemsResponseAgentsSynced{value: val, isSet: true}
}

func (v NullableAllItemsResponseAgentsSynced) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseAgentsSynced) UnmarshalJSON(src []byte) error {
	v.isSet = true
