...
// checks if the AllItemsResponseRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseRules{}

// AllItemsResponseRules struct for AllItemsResponseRules
...
type _AllItemsResponseRules AllItemsResponseRules
...
func (o AllItemsResponseRules) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseRules) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseRules) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseRules := _AllItemsResponseRules{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseRules)

	if err != nil {
		return err
	}

	*o = AllItemsResponseRules(varAllItemsResponseRules)

	return err
}

type NullableAllItemsResponseRules struct {
	value *AllItemsResponseRules
	isSet bool
}

func (v NullableAllItemsResponseRules) Get() *AllItemsResponseRules {
	return v.value
}

func (v *NullableAllItemsResponseRules) Set(val *AllItemsResponseRules) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseRules) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseRules(val *AllItemsResponseRules) *NullableAllItemsResponseRules {
	return &NullableAllItemsResponseRules{value: val, isSet: true}
}

func (v NullableAllItemsResponseRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
