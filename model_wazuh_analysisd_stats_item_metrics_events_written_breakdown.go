...
// checks if the WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown{}

// WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown struct for WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown
type WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown struct {
...
func NewWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown() *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown {
	this := WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown{}
	return &this
}
...
// SetFts gets a reference to the given int32 and assigns it to the Fts field.
...
// SetStats gets a reference to the given int32 and assigns it to the Stats field.
func (o *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) SetStats(v int32) {
	o.Stats = &v
}

func (o WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown struct {
	value *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) Get() *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) Set(val *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown(val *WazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) *NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown {
	return &NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsEventsWrittenBreakdown) UnmarshalJSON(src []byte) error {
	v.isSet = true
