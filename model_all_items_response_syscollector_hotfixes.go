...
// checks if the AllItemsResponseSyscollectorHotfixes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSyscollectorHotfixes{}

// AllItemsResponseSyscollectorHotfixes struct for AllItemsResponseSyscollectorHotfixes
...
type _AllItemsResponseSyscollectorHotfixes AllItemsResponseSyscollectorHotfixes
...
func NewAllItemsResponseSyscollectorHotfixes(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SyscollectorHotfix) *AllItemsResponseSyscollectorHotfixes {
	this := AllItemsResponseSyscollectorHotfixes{}
...
func (o AllItemsResponseSyscollectorHotfixes) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSyscollectorHotfixes) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSyscollectorHotfixes) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSyscollectorHotfixes := _AllItemsResponseSyscollectorHotfixes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSyscollectorHotfixes)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSyscollectorHotfixes(varAllItemsResponseSyscollectorHotfixes)

	return err
}

type NullableAllItemsResponseSyscollectorHotfixes struct {
	value *AllItemsResponseSyscollectorHotfixes
	isSet bool
}

func (v NullableAllItemsResponseSyscollectorHotfixes) Get() *AllItemsResponseSyscollectorHotfixes {
	return v.value
}

func (v *NullableAllItemsResponseSyscollectorHotfixes) Set(val *AllItemsResponseSyscollectorHotfixes) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSyscollectorHotfixes) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSyscollectorHotfixes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSyscollectorHotfixes(val *AllItemsResponseSyscollectorHotfixes) *NullableAllItemsResponseSyscollectorHotfixes {
	return &NullableAllItemsResponseSyscollectorHotfixes{value: val, isSet: true}
}

func (v NullableAllItemsResponseSyscollectorHotfixes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSyscollectorHotfixes) UnmarshalJSON(src []byte) error {
	v.isSet = true
