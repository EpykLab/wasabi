...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesUpgrade type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesUpgrade{}

// WazuhAnalysisdStatsItemMetricsQueuesUpgrade struct for WazuhAnalysisdStatsItemMetricsQueuesUpgrade
type WazuhAnalysisdStatsItemMetricsQueuesUpgrade struct {
	// Upgrade messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesUpgrade() *WazuhAnalysisdStatsItemMetricsQueuesUpgrade {
	this := WazuhAnalysisdStatsItemMetricsQueuesUpgrade{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesUpgrade) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesUpgrade) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesUpgrade
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) Get() *WazuhAnalysisdStatsItemMetricsQueuesUpgrade {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) Set(val *WazuhAnalysisdStatsItemMetricsQueuesUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade(val *WazuhAnalysisdStatsItemMetricsQueuesUpgrade) *NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesUpgrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
