...
// checks if the AllItemsResponseWazuhLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseWazuhLogs{}

// AllItemsResponseWazuhLogs struct for AllItemsResponseWazuhLogs
...
type _AllItemsResponseWazuhLogs AllItemsResponseWazuhLogs
...
func NewAllItemsResponseWazuhLogs(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []WazuhLogs) *AllItemsResponseWazuhLogs {
	this := AllItemsResponseWazuhLogs{}
...
func (o AllItemsResponseWazuhLogs) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseWazuhLogs) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseWazuhLogs) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseWazuhLogs := _AllItemsResponseWazuhLogs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseWazuhLogs)

	if err != nil {
		return err
	}

	*o = AllItemsResponseWazuhLogs(varAllItemsResponseWazuhLogs)

	return err
}

type NullableAllItemsResponseWazuhLogs struct {
	value *AllItemsResponseWazuhLogs
	isSet bool
}

func (v NullableAllItemsResponseWazuhLogs) Get() *AllItemsResponseWazuhLogs {
	return v.value
}

func (v *NullableAllItemsResponseWazuhLogs) Set(val *AllItemsResponseWazuhLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseWazuhLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseWazuhLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseWazuhLogs(val *AllItemsResponseWazuhLogs) *NullableAllItemsResponseWazuhLogs {
	return &NullableAllItemsResponseWazuhLogs{value: val, isSet: true}
}

func (v NullableAllItemsResponseWazuhLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseWazuhLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true
