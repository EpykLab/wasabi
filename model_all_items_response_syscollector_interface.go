...
// checks if the AllItemsResponseSyscollectorInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSyscollectorInterface{}

// AllItemsResponseSyscollectorInterface struct for AllItemsResponseSyscollectorInterface
...
type _AllItemsResponseSyscollectorInterface AllItemsResponseSyscollectorInterface
...
func NewAllItemsResponseSyscollectorInterface(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SyscollectorInterface) *AllItemsResponseSyscollectorInterface {
	this := AllItemsResponseSyscollectorInterface{}
...
func (o AllItemsResponseSyscollectorInterface) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSyscollectorInterface) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSyscollectorInterface) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSyscollectorInterface := _AllItemsResponseSyscollectorInterface{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSyscollectorInterface)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSyscollectorInterface(varAllItemsResponseSyscollectorInterface)

	return err
}

type NullableAllItemsResponseSyscollectorInterface struct {
	value *AllItemsResponseSyscollectorInterface
	isSet bool
}

func (v NullableAllItemsResponseSyscollectorInterface) Get() *AllItemsResponseSyscollectorInterface {
	return v.value
}

func (v *NullableAllItemsResponseSyscollectorInterface) Set(val *AllItemsResponseSyscollectorInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSyscollectorInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSyscollectorInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSyscollectorInterface(val *AllItemsResponseSyscollectorInterface) *NullableAllItemsResponseSyscollectorInterface {
	return &NullableAllItemsResponseSyscollectorInterface{value: val, isSet: true}
}

func (v NullableAllItemsResponseSyscollectorInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSyscollectorInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
