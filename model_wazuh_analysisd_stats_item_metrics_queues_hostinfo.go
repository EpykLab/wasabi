...
// checks if the WazuhAnalysisdStatsItemMetricsQueuesHostinfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhAnalysisdStatsItemMetricsQueuesHostinfo{}

// WazuhAnalysisdStatsItemMetricsQueuesHostinfo struct for WazuhAnalysisdStatsItemMetricsQueuesHostinfo
type WazuhAnalysisdStatsItemMetricsQueuesHostinfo struct {
	// Hostinfo messages queue size
...
func NewWazuhAnalysisdStatsItemMetricsQueuesHostinfo() *WazuhAnalysisdStatsItemMetricsQueuesHostinfo {
	this := WazuhAnalysisdStatsItemMetricsQueuesHostinfo{}
	return &this
}
...
func (o WazuhAnalysisdStatsItemMetricsQueuesHostinfo) MarshalJSON() ([]byte, error) {
...
func (o WazuhAnalysisdStatsItemMetricsQueuesHostinfo) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo struct {
	value *WazuhAnalysisdStatsItemMetricsQueuesHostinfo
	isSet bool
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) Get() *WazuhAnalysisdStatsItemMetricsQueuesHostinfo {
	return v.value
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) Set(val *WazuhAnalysisdStatsItemMetricsQueuesHostinfo) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo(val *WazuhAnalysisdStatsItemMetricsQueuesHostinfo) *NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo {
	return &NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo{value: val, isSet: true}
}

func (v NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhAnalysisdStatsItemMetricsQueuesHostinfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
