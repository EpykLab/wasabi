...
// checks if the WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb{}

// WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb Number of queries per operation
type WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb struct {
...
func NewWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb() *WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb {
	this := WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb{}
	return &this
}
...
// SetCommit gets a reference to the given int32 and assigns it to the Commit field.
...
func (o WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) MarshalJSON() ([]byte, error) {
...
func (o WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) ToMap() (map[string]interface{}, error) {
...
type NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb struct {
	value *WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb
	isSet bool
}

func (v NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) Get() *WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb {
	return v.value
}

func (v *NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) Set(val *WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) {
	v.value = val
	v.isSet = true
}

func (v NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) IsSet() bool {
	return v.isSet
}

func (v *NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb(val *WazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) *NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb {
	return &NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb{value: val, isSet: true}
}

func (v NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWazuhDBStatsItemMetricsQueriesReceivedBreakdownAgentBreakdownDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
