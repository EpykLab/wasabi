...
// checks if the AllItemsResponseSyscollectorNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseSyscollectorNetwork{}

// AllItemsResponseSyscollectorNetwork struct for AllItemsResponseSyscollectorNetwork
...
type _AllItemsResponseSyscollectorNetwork AllItemsResponseSyscollectorNetwork
...
func NewAllItemsResponseSyscollectorNetwork(totalAffectedItems int32, failedItems []SimpleApiError, totalFailedItems int32, affectedItems []SyscollectorNetwork) *AllItemsResponseSyscollectorNetwork {
	this := AllItemsResponseSyscollectorNetwork{}
...
func (o AllItemsResponseSyscollectorNetwork) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseSyscollectorNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseSyscollectorNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseSyscollectorNetwork := _AllItemsResponseSyscollectorNetwork{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseSyscollectorNetwork)

	if err != nil {
		return err
	}

	*o = AllItemsResponseSyscollectorNetwork(varAllItemsResponseSyscollectorNetwork)

	return err
}

type NullableAllItemsResponseSyscollectorNetwork struct {
	value *AllItemsResponseSyscollectorNetwork
	isSet bool
}

func (v NullableAllItemsResponseSyscollectorNetwork) Get() *AllItemsResponseSyscollectorNetwork {
	return v.value
}

func (v *NullableAllItemsResponseSyscollectorNetwork) Set(val *AllItemsResponseSyscollectorNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseSyscollectorNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseSyscollectorNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseSyscollectorNetwork(val *AllItemsResponseSyscollectorNetwork) *NullableAllItemsResponseSyscollectorNetwork {
	return &NullableAllItemsResponseSyscollectorNetwork{value: val, isSet: true}
}

func (v NullableAllItemsResponseSyscollectorNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseSyscollectorNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
