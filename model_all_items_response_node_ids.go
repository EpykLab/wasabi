...
// checks if the AllItemsResponseNodeIDs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllItemsResponseNodeIDs{}

// AllItemsResponseNodeIDs struct for AllItemsResponseNodeIDs
...
type _AllItemsResponseNodeIDs AllItemsResponseNodeIDs
...
func (o AllItemsResponseNodeIDs) MarshalJSON() ([]byte, error) {
...
func (o AllItemsResponseNodeIDs) ToMap() (map[string]interface{}, error) {
...
func (o *AllItemsResponseNodeIDs) UnmarshalJSON(data []byte) (err error) {
	...
	varAllItemsResponseNodeIDs := _AllItemsResponseNodeIDs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllItemsResponseNodeIDs)

	if err != nil {
		return err
	}

	*o = AllItemsResponseNodeIDs(varAllItemsResponseNodeIDs)

	return err
}

type NullableAllItemsResponseNodeIDs struct {
	value *AllItemsResponseNodeIDs
	isSet bool
}

func (v NullableAllItemsResponseNodeIDs) Get() *AllItemsResponseNodeIDs {
	return v.value
}

func (v *NullableAllItemsResponseNodeIDs) Set(val *AllItemsResponseNodeIDs) {
	v.value = val
	v.isSet = true
}

func (v NullableAllItemsResponseNodeIDs) IsSet() bool {
	return v.isSet
}

func (v *NullableAllItemsResponseNodeIDs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllItemsResponseNodeIDs(val *AllItemsResponseNodeIDs) *NullableAllItemsResponseNodeIDs {
	return &NullableAllItemsResponseNodeIDs{value: val, isSet: true}
}

func (v NullableAllItemsResponseNodeIDs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllItemsResponseNodeIDs) UnmarshalJSON(src []byte) error {
	v.isSet = true
